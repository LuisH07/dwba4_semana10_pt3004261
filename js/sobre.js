class Sobre extends React.Component{
  constructor(){
    super();
    this.texto={if: "Instituto Federal de Educação, Ciência e Tecnologia de São Paulo",                endereco: "Rua Pedro Vicente, 625 - Canindé - São Paulo - SP - Brasil -                Cep: 01109-010"};
  }

  render(){
    return <div>
      <p>O <strong>{this.texto.if}</strong> – é uma autarquia federal de ensino.</p>
      ...
      <p>Localizado em <strong>{this.texto.endereco}</strong></p>
